...
{
   Socket s;
   Vector<Socket> socketss = new Vector<Socket>();
   final int portnum = 1234;

   public ServerDetective()
   {
      try
      {
         ...
         while(true)
         {
            ...
            s = ss.accept();
            socketss.add(s);
            ThreadedClass i1 = new ThreadedClass(s);
            i1.start();
   ...
   ActionEvent ae;
         ...
         try
         {
            ...
            while(true)
            {
               ...
               if(message != null)
               {
                ...
                JTextArea sugR = (JTextArea) ois.readObject();
               sug = sugR;
               System.out.print("A");
               ...
               player = playerR;
               System.out.print("D");
               JLabel bulletsR = (JLabel) ois.readObject();
               bullets = bulletsR;
               System.out.print("E");
               ...
               // up = upR;
               System.out.print("K");
               ActionEvent aeR = (ActionEvent) ois.readObject();
               ae = aeR;
               System.out.print("L");

               puzzle(ae);
               System.out.print(" method done ");
               dos.writeObject(sug);
               dos.flush();
               System.out.print("1");
               dos.writeObject(killer);
               dos.flush();
               System.out.print("2");
               dos.writeObject(status);
               dos.flush();
               System.out.print("3");
               dos.flush();
               dos.flush();
               ...
               dos.flush();
               System.out.print("4");
               dos.writeObject(bullets);
               dos.flush();
               System.out.print("5");
               dos.writeObject(jta);
               System.out.print("5A");
               dos.writeObject(jbStart);
               dos.flush();
               System.out.print("6");
               dos.writeObject(jbKill);
               dos.flush();
               System.out.print("7");
               dos.writeObject(down);
               dos.flush();
               System.out.print("8");
               dos.writeObject(jta2);
               dos.flush();
               System.out.print("9");
               dos.writeObject(up);
               dos.flush();
               ...
               dos.writeObject("" + alive);
               dos.flush();

               dos.writeObject(commander);
               dos.flush();
               commander = "N";
               System.out.print("11");
               System.out.print("\n");
      ...
      public void puzzle(ActionEvent ae){
         	try {
			//Alisher
   ...
   public static void main(String[]args)
   {
      ...
      ServerDetective s1 = new ServerDetective();
